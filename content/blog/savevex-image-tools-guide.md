...
1. **Crop first** — frame your subject and remove distractions.
2. **Resize next** — set the target dimensions for your output.
3. **Compress last** — reduce file size for web or email.
