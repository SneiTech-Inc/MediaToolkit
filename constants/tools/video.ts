...
export const videoTools = [
  {
    ...
    dateAdded: '2024-01-08', inputFormats: ['mp4', 'mov', 'webm', 'mkv'], outputFormats: ['mp4', 'webm'], isComingSoon: false,
  },
  {
    ...
    dateAdded: '2024-01-08', inputFormats: ['mp4', 'mov', 'webm', 'mkv', 'avi'], outputFormats: ['mp4', 'webm', 'mov'], isComingSoon: false,
  },
  {
    ...
    dateAdded: '2024-01-08', inputFormats: ['mp4', 'mov', 'webm'], outputFormats: ['mp4', 'webm'], isComingSoon: false,
  },
  {
    ...
    dateAdded: '2024-01-09', inputFormats: ['mp4', 'mov', 'webm'], outputFormats: ['mp4', 'webm'], isComingSoon: false,
  },
  {
  ...
  },
  {
    ...
    dateAdded: '2024-01-10', inputFormats: ['mp4', 'mov', 'webm'], outputFormats: ['mp4', 'webm'], isComingSoon: false,
  },
  {
  ...
  },
  {
    ...
    dateAdded: '2024-01-11', inputFormats: ['mp4', 'mov', 'webm', 'mkv'], outputFormats: ['mp3', 'wav'], isComingSoon: false,
  },
  {
    ...
    dateAdded: '2024-01-11', inputFormats: ['mp4', 'mov', 'webm'], outputFormats: ['gif'], isComingSoon: false,
  },
