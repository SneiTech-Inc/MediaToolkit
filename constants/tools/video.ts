...
export const videoTools = [
  ...
  },
  {
    ...
    description: 'Extract audio from video files as MP3, WAV, AAC, OGG, FLAC, or M4A. Free, fast, also known as Video to Audio, and entirely in your browser.', icon: '🎧', badge: 'popular',
